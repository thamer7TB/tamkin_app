...
class OnBordingCompany extends StatelessWidget {
  final PageController controller;
  const OnBordingCompany({super.key, required this.controller});
    ...
    return  Scaffold(
      body: SafeArea(child: Column (
        ...
        children: [
          ...
          SvgPicture.asset(ImagesManager.onBordingCompanyImage,
            width : screenWidth ,
              ...
              child: Column(
                  children: [
                    Align (
                      ...
                      child: Text(
                        StringsManager.onBordingCompanyTitle ,
                    ...
                    Align (
                      alignment: Alignment.centerLeft ,
                      child: Text(
                        StringsManager.onBordingrCompanyDec,
