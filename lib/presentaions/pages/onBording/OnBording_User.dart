...
class OnBordingUser extends StatelessWidget {
  final PageController controller;
  const OnBordingUser({super.key, required this.controller});
      ...
      body: SafeArea(child: Column (
        ...
        children: [
          ...
          SizedBox(height: screenHeight * 0.02 ,),
           ...
           SvgPicture.asset("assets/images/onbording/user1.svg",
           width : screenWidth ,
            ...
            child: Column(
              children: [
                Align (
                  ...
                  child: Text(
                    StringsManager.onBordingUserTitle ,
                ...
                Align (
                  alignment: Alignment.centerLeft ,
                  child: Text(
                    StringsManager.onBordingUserDec,
